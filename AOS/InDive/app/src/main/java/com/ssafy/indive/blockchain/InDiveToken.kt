...
class InDiveToken : Contract {
    ...
    fun INITIAL_SUPPLY(): RemoteFunctionCall<BigInteger> {
    ...
    fun addressOfContract(): RemoteFunctionCall<String> {
        val function = Function(
            FUNC_ADDRESSOFCONTRACT,
            Arrays.asList(),
    ...
    companion object {
        ...
        const val FUNC_INITIAL_SUPPLY = "INITIAL_SUPPLY"
        const val FUNC_ADDRESSOFCONTRACT = "addressOfContract"
        ...
        fun load(
            ...
            return InDiveToken(contractAddress, web3j, credentials, gasPrice, gasLimit)
        }
        ...
        fun load(
            ...
            return InDiveToken(contractAddress, web3j, transactionManager, gasPrice, gasLimit)
        }
        ...
        fun load(
            ...
            return InDiveToken(contractAddress, web3j, credentials, contractGasProvider)
        }
        ...
        fun load(
            ...
            return InDiveToken(contractAddress, web3j, transactionManager, contractGasProvider)
        }
    }
}