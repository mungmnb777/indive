...
//
//
//class AdapterEx(private val crewUserRankingViewModel: CrewUserRankingViewModel, private val crewUserRankingListener : CrewUserRankingListener) : ListAdapter<RankingResponse, AdapterEx.ViewHolder>(diffUtil){
//
